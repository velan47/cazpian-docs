...
const config: Config = {
  ...
  organizationName: 'cazpian', // Usually your GitHub org/user name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/cazpian/cazpian-docs/tree/main/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/cazpian/cazpian-docs',
          position: 'right',
